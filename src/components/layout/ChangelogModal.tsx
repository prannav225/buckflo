  ...
  return createPortal(
    <div className="sheet-overlay" role="dialog" aria-modal="true">
      <div className="flex items-center justify-center min-h-screen px-4 pb-12 pt-4">
        <div className="bg-(--bg-glass) [-webkit-backdrop-filter:blur(32px)_saturate(200%)] [backdrop-filter:blur(32px)_saturate(200%)] border border-black/8 dark:border-white/6 shadow-(--glass-shadow-lg) rounded-(--r-2xl) w-full max-w-sm overflow-hidden flex flex-col slide-up relative">
          <button
            onClick={handleClose}
          ...
          <div className="p-6 pb-4 border-b border-black/5 dark:border-white/5 relative overflow-hidden">
            ...
            <div className="w-12 h-12 rounded-2xl bg-linear-to-br from-(--accent) to-(--accent-dark) flex items-center justify-center shadow-lg shadow-(--accent)/20 mb-4 relative z-10">
          ...
          <div className="p-6 py-5 overflow-y-auto max-h-[50vh] flex flex-col gap-5">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-(--text-muted) mt-0.5 leading-relaxed">
                  We've rebranded "Accounts" to "Spending Wallet" and "Savings
                  Wallet" to better reflect how you actually use your money.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                <h4 className="font-semibold text-(--text) text-sm">
                  Income-Based Setup Wizard
                </h4>
                <p className="text-xs text-(--text-muted) mt-0.5 leading-relaxed">
                  A smarter way to plan your month. Start with your income,
                  subtract fixed costs, and see exactly what's left.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-(--text-muted) mt-0.5 leading-relaxed">
                  Feel your finances. Subtle haptic feedback across the app
                  makes every interaction satisfying.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                <h4 className="font-semibold text-(--text) text-sm">
                  Smart Insights & Monthly Review
                </h4>
                <p className="text-xs text-(--text-muted) mt-0.5 leading-relaxed">
                  Get deeper insights into your spending patterns and close out
                  your month with a beautiful summary screen.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 border-t border-black/5 dark:border-white/5 bg-black/5 dark:bg-white/5">
            <button onClick={handleClose} className="btn-primary w-full h-12">
