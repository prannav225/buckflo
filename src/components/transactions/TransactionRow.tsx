...
export function TransactionCard({
  ...
  const catColor = getCategoryColor(categories, tx.category);
  ...
  return (
    <>
      ...
      >
        {/* Icon — uses category colour */}
        <div
          className="w-10 h-10 rounded-(--r-md) flex items-center justify-center border border-gray-50/10 shrink-0"
